...
const requiredPairs = [
  ...
  ['callout muted on paper', '#5f5d57', '#fbfaf6', 4.5],
];
...
assert.match(css, /\.callout h3\{font-family/);
assert.match(css, /\.callout p\{color:var\(--muted\)/);
